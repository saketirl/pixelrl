#!/bin/bash
#SBATCH --job-name=stg3-crate-adam-gaps
#SBATCH --output=slurm_logs/staging3_crate_adam_gaps_%A.out
#SBATCH -N 1
#SBATCH --ntasks=1
...
# No missing canonical crate_adam seeds were found in plots/staging_data/seed_coverage.csv.

CONFIG_NAME="crate_adam"
HEADARCH="crate"
