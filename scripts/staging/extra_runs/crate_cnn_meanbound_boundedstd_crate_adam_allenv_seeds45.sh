#!/bin/bash
#SBATCH --job-name=stg2-cratecnn-boundstd-adam-allenv2
#SBATCH --output=slurm_logs/staging2_crate_cnn_meanbound_boundedstd_crate_adam_allenv_seeds45_%A_%a.out
#SBATCH -N 1
#SBATCH --ntasks=1
...
# Extra staging seeds for the Adam-only CRATE-head ablation. Same config as
# the 4-seed staging run, but with seeds 4 and 5.
#
# Swept:
