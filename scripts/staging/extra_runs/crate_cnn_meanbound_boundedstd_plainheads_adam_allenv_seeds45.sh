#!/bin/bash
#SBATCH --job-name=stg2-cratecnn-boundstd-plain-adam2
#SBATCH --output=slurm_logs/staging2_crate_cnn_meanbound_boundedstd_plainheads_adam_allenv_seeds45_%A_%a.out
#SBATCH -N 1
#SBATCH --ntasks=1
...
# Extra staging seeds for the plain-head Adam ablation. Same config as the
...
GROUP_NAME="staging2_crate_cnn_meanbound_boundedstd_plainheads_adam_allenv_seeds45_${GROUP_ID}"
...
EXP_NAME="ppo_staging2_cratecnn_meanbound_boundedstd_plainheads_adam_${ENV_NAME}_b${BACKEND}_s${SEED}_t${TASK_ID}"
