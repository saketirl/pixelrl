#!/bin/bash
#SBATCH --job-name=hum-goal-cratecnn-adam
#SBATCH --output=slurm_logs/humanoid_goal_cratecnn_crateheads_bestreward_adam_single_%j.out
#SBATCH -N 1
#SBATCH --ntasks=1
...
# humanoid_goal with CRATE-CNN encoder + CRATE heads, Adam optimizer, single seed.
# One process per GPU.
