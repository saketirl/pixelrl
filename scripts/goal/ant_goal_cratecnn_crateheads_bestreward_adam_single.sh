#!/bin/bash
#SBATCH --job-name=ant-goal-cratecnn-adam
#SBATCH --output=slurm_logs/ant_goal_cratecnn_crateheads_bestreward_adam_single_%j.out
#SBATCH -N 1
#SBATCH --ntasks=1
...
# ant_goal with CRATE-CNN encoder + CRATE heads, Adam optimizer, single seed.
# One process per GPU.
