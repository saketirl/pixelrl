#!/bin/bash
#SBATCH --job-name=cl-brax-hopper-friction
#SBATCH --output=slurm_logs/cl_brax_hopper_friction_%j.out
#SBATCH -N 1
#SBATCH --ntasks=1
...
# State-observation Brax continual Hopper launcher using the Dohare-style
...
ENV_NAME="hopper"
CONFIG_BASENAME="hopper_friction_dohare"
