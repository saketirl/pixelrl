#!/bin/bash
#SBATCH --job-name=cl-brax-walker-friction
#SBATCH --output=slurm_logs/cl_brax_walker2d_friction_%j.out
#SBATCH -N 1
#SBATCH --ntasks=1
...
# State-observation Brax continual Walker2d launcher using the Dohare-style
...
ENV_NAME="walker2d"
CONFIG_BASENAME="walker2d_friction_dohare"
