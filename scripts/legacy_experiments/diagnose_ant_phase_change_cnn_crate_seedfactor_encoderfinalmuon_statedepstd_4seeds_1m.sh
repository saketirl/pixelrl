#!/bin/bash
#SBATCH --job-name=diagnose-ant-phase-change-cnn-crate-seedfactor-encoderfinalmuon-statedepstd-4seeds-1m
#SBATCH --output=slurm_logs/diagnose_ant_phase_change_cnn_crate_seedfactor_encoderfinalmuon_statedepstd_statedepstd_4seeds_1m_%A_%a.out
#SBATCH -N 1
#SBATCH --ntasks=1
...
GROUP_NAME="diagnose_ant_phase_change_cnn_crate_seedfactor_encoderfinalmuon_statedepstd_${FACTOR_TAG}_fix${FIXED_SEED}_${GROUP_ID}"
export WANDB_RUN_GROUP="${GROUP_NAME}"
export WANDB_TAGS="ant_phase_change,diagnosis,env_ant,backend_${BACKEND},seedfactor,${FACTOR_TAG},fixed_seed_${FIXED_SEED},varied_seed_${VARIED_SEED},init_seed_${INIT_SEED},data_seed_${DATA_SEED},headopt_muon,headarch_crate,encoder_cnn,encoder_final_muon,state_dependent_std,innovation_off,lr_anneal_off,probe_off,1m_steps"
