#!/bin/bash
#SBATCH --job-name=diagnose-ant-phase-change-innovationdirect-seedfactor-4seeds-1m
#SBATCH --output=slurm_logs/diagnose_ant_phase_change_innovationdirect_seedfactor_4seeds_1m_%A_%a.out
#SBATCH -N 1
#SBATCH --ntasks=1
