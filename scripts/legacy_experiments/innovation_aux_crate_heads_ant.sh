#!/bin/bash
#SBATCH --job-name=innovation-aux-crate-heads-ant
#SBATCH --output=slurm_logs/innovation_aux_crate_heads_ant_%A_%a.out
#SBATCH -N 1
#SBATCH --ntasks=1
...
# Ant-only innovation-aware auxiliary experiment.
...
GROUP_NAME="innovation_aux_crate_heads_ant_${GROUP_ID}"
