#!/bin/bash
#SBATCH --job-name=cnn-crate-adam-multi
#SBATCH --output=slurm_logs/cnn_crate_adam_multi_%A_%a.out
#SBATCH -N 1
#SBATCH --ntasks=1
...
# CNN encoder with CRATE heads and ADAM optimizer
...
GROUP_NAME="cnn_crate_adam_multi_${GROUP_ID}"
export WANDB_RUN_GROUP="${GROUP_NAME}"
export WANDB_TAGS="cnn_crate_adam,encoder_cnn,opt_adam,env_${ENV_NAME},backend_${BACKEND},seed_${SEED},scale_${ENCODER_SCALE},crate,sweep4seeds"
