#!/bin/bash
#SBATCH --job-name=cnn-vit-muon-me
#SBATCH --output=slurm_logs/cnn_vit_heads_muon_me_%A_%a.out
#SBATCH -N 1
#SBATCH --ntasks=1
...
# Compare encoder architecture (CNN vs ViT) and head optimizer (MUON vs Adam)
...
GROUP_NAME="cnn_vit_heads_muon_me_${GROUP_ID}"
export WANDB_RUN_GROUP="${GROUP_NAME}"
export WANDB_TAGS="cnn_vit_heads_muon_me,encoder_${ENCODER_TYPE},opt_${OPT_CONDITION},env_${ENV_NAME},backend_${BACKEND},seed_${SEED},allenv9,sweep6seeds"
